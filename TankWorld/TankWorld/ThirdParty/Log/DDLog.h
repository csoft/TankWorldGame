...
#define LOG_ERROR_RCS   (ddLogLevel & LOG_FLAG_ERROR)
#define LOG_WARN_RCS    (ddLogLevel & LOG_FLAG_WARN)
#define LOG_INFO_RCS    (ddLogLevel & LOG_FLAG_INFO)
#define LOG_VERBOSE_RCS (ddLogLevel & LOG_FLAG_VERBOSE)
